window.onload = function () {
    ...
    // link de referência https://stackoverflow.com/questions/9012537/how-to-get-the-element-clicked-for-the-whole-document
    ...
    function restart() {
        for (indice = 0; indice < pixel.length; indice += 1) {
            pixel[indice].classList.add("white")
        }
    }
}